# src/interfaz/ventana_crear_cuenta.py
...
class VentanaCrearCuenta(QDialog):
    ...
    def crear_cuenta(self):
        ...
        if nuevo_usuario:
            mostrar_mensaje(self, "Éxito", "Cuenta creada correctamente.", tipo="info")
            self.accept()
        else:
            mostrar_mensaje(self, "Error", "No se pudo crear el usuario. Puede que ya exista.", tipo="error")
